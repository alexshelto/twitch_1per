...
export class ViewChat extends React.Component {
    ...
    componentDidMount() { 
        document.title = `twitch filter | ${this.state.channel} view`;
    ...
    render() {
        ...
        return(
          <Fragment>
            <div class='top-info'>
                <h1 class="centered-info"> {this.state.messageCount}/{this.state.messageLimit} messages | target phrase: {this.state.prefix}</h1> 
                {StopButton}
